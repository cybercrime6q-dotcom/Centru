...
try:
    ...
    print("✅ Firebase Admin berhasil inisialisasi", file=sys.stderr)
except Exception as e:
    print("❌ Gagal inisialisasi Firebase:", e, file=sys.stderr)
    raise e
