...
# ===============================
# Ganti 'firebase_key.json' dengan path file credential kamu
...
def register():
    try:
        ...
        print("Error register:", e)  # muncul di logs Render
